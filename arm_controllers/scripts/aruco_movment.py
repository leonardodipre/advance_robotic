...
class SinusoidalMotionMarker:
    def __init__(self):
        ...
        self.base_radius = 0.4   # Base radius of the path
        ...
        self.amplitude = 0.1   # Amplitude of the sine wave
        self.num_cycles = 6    # Number of sine wave cycles around the circle
